...
export interface Strings {
  ...
  newTag: string; pluginsInvite: string; submitPlugin: string; comingSoon: string;
  ...
  pubKicker: string; pubEntries: string; tagKicker: string;
...
export const STRINGS: Record<Lang, Strings> = {
  zh: {
    ...
    pubKicker: "发布者 · Publisher", pubEntries: "{n} 件作品", tagKicker: "标签 · Tag",
  ...
  en: {
    ...
    pubKicker: "Publisher", pubEntries: "{n} entries", tagKicker: "Tag",
