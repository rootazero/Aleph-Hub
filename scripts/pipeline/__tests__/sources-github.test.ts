...
describe("GitHubSource", () => {
  it("collects repos from queries + expands seed lists + includes pins, attaching READMEs", async () => {
    const src = new GitHubSource({ gh, http, seeds: { queries: ["topic:mcp"], seeds: ["https://github.com/list/awesome"], pins: ["pinned/mcp-server"] } });
    ...
    expect(urls).toContain("https://github.com/pinned/mcp-server"); // pin included directly
